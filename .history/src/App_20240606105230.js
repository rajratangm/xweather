  ...
  const getBackgroundImage = () => {
    if (weatherData.length > 0) {
      ...
      switch (weatherCondition) {
        case "clear":
          return "url('/path/to/sunny-background.jpg')";
        case "clouds":
          return "url('/path/to/cloudy-background.jpg')";
        case "rain":
          return "url('/path/to/rainy-background.jpg')";
        
        default:
          return "url('/path/to/default-background.jpg')";
      }
    }
    return "url('/path/to/default-background.jpg')"; // Default background image if weather data is not available
  };
