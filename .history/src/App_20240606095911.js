          ...
          {weatherData.map((weather, index) => (
            <div className="weather-card" key={index}>
              ...
              >
                ...
                <p>
                  Temperature: {main.main.temp}°C<br/>
                  ...
                  <div className="text-md pt-4 pb-4 px-4">
                    ...
                    <div className="card-body">
                      <div className="flex items-center">
                        <span className="badge text-md py-1 h-12px w-12px rounded right-1 bottom-1 px-4">{weather.description}</span>
                      </div>
                    </div>
                  </div>
                </div>
...
//                       </div>
//                       <div>
//                         <h1 className="text-6xl"> {main.main.temp}° </h1>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
